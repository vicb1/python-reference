...
`conda create -n kaggle12 python=3.8.5`<br> OR `3.7.6` for kaggle <br>
`conda activate kaggle12 && \ conda install ipykernel`<br>
`ipython kernel install --user --name=kaggle12`<br>
