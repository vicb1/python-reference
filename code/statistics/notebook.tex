...
\makeatother
    ...
    \section{Bell curve formula}\label{bell-curve-formula}

Bell curve formula equation and parameter interaction: - graph:
https://www.desmos.com/calculator/idg0pi2pbf - TODO: add kurtosis

\includegraphics{./bell_curve_formula_graph.png} - with mean, sigma,
skew: -
...
\tightlist
\item
  https://en.wikipedia.org/wiki/Skew\_normal\_distribution
\item
